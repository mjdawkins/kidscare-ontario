      ...
      <main className="flex-1 px-4 py-12 pb-24 md:py-20">
        <div className="mx-auto max-w-lg space-y-10">
          <div className="space-y-3 text-center">
            ...
            <p className="text-lg text-neutral-800 max-w-sm mx-auto">
          ...
          <div className="space-y-4">
            ...
            >
              ...
              <div className="min-w-0">
                <h2 className="font-semibold text-neutral-900 group-hover:text-red-700 transition-colors">
                  Urgent Care
                </h2>
            ...
            >
              ...
              <div className="min-w-0">
                <h2 className="font-semibold text-neutral-900 group-hover:text-blue-700 transition-colors">
                  Find a Doctor
                </h2>
                <p className="text-sm text-neutral-800 mt-0.5">
